...
<body>
    ...
    <div class="update-box red-bg">
        ...
        <button class="btn-yellow">View All Announcements</button>
    </div>
    ...
    <div class="update-box white-bg">
        ...
        <button class="btn-blue">View Full Calendar</button>
    </div>
</section>

    <section class="cta-section" >
        <h2>Ready to Transform Youth Governance?</h2>
        <p>Join SK 360° today and experience seamless coordination, transparent reporting, and empowered youth leadership in Lipa City.</p>
        <button class="btn-large-red" >Get Started Now</button>
    </section>
    ...
    <div class="footer-top">
        <div class="footer-column brand-info">
            <div class="footer-logo">
                <img src="logo.png" alt="SK 360 Logo">
                <span class="logo-text">SK 360°</span>
            </div>
    ...
    <div class="footer-bottom">
        <p>© 2026 SK 360°. All rights reserved.</p>
